...
namespace Dipterv.Dal.DbContext
{
    public partial class FusionDbContext : IdentityDbContext<ApplicationUser, IdentityRole<long>, long>
    {
        ...
        public DbSet<DbUser<long>> FusionUsers { get; protected set; } = null!;
        public DbSet<DbUserIdentity<long>> UserIdentities { get; protected set; } = null!;
        public DbSet<DbSessionInfo<long>> Sessions { get; set; } = null!;
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder
                    .UseSqlServer("Data Source=localhost,3033;Initial Catalog=AdventureWorks2019;Integrated Security=False;User Id=sa;Password=Password123!;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False", x => x.UseNetTopologySuite())
